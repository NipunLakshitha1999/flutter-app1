...
import 'OlEnglishPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlEnglishPapers extends StatefulWidget {
  @override
  OlEnglishPapersState createState() => OlEnglishPapersState();
}

class OlEnglishPapersState extends State<OlEnglishPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlEnglishPapersType()));
                  },
                  child: Container(
              ...
              Container(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(20),
                      child: Image.asset('assets/images/Number2001.jpg',fit: BoxFit.fill,),
