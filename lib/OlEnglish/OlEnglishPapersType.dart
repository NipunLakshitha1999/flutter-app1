...
class OlEnglishPapersType extends StatefulWidget{
  @override
  OlEnglishPapersTypeState createState() => OlEnglishPapersTypeState();

}

class OlEnglishPapersTypeState extends State<OlEnglishPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlEnglishPapers())),
                child: Text('YES'),
              ),
              FlatButton(
