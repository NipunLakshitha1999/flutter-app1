...
import '../OlIslam/OlIslammPapersType.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlIslamPapers extends StatefulWidget {
  @override
  OlIslamPapersState createState() => OlIslamPapersState();
}

class OlIslamPapersState extends State<OlIslamPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlIslamPapersType()));
                  },
                  child: Container(
