...
class OlIslamPapersType extends StatefulWidget{
  @override
  OlIslamPapersTypeState createState() => OlIslamPapersTypeState();

}

class OlIslamPapersTypeState extends State<OlIslamPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlIslamPapers())),
                child: Text('YES'),
              ),
              FlatButton(
