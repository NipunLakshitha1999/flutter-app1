...
import 'OlCatholicmPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlCatholicmPapers extends StatefulWidget {
  @override
  OlCatholicmPapersState createState() => OlCatholicmPapersState();
}

class OlCatholicmPapersState extends State<OlCatholicmPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlCatholicmPapersType()));
                  },
                  child: Container(
