...
class OlCatholicmPapersType extends StatefulWidget{
  @override
  OlCatholicmPapersTypeState createState() => OlCatholicmPapersTypeState();

}

class OlCatholicmPapersTypeState extends State<OlCatholicmPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlCatholicmPapers())),
                child: Text('YES'),
              ),
              FlatButton(
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_2000_Catholicam_Sinhala.pdf",
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Catholicam_English.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Catholicam_Tamil.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
