...
import 'OlChristianityPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlCristianityPapers extends StatefulWidget {
  @override
  OlCristianityPapersState createState() => OlCristianityPapersState();
}

class OlCristianityPapersState extends State<OlCristianityPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlChristianityPapersType()));
                  },
                  child: Container(
