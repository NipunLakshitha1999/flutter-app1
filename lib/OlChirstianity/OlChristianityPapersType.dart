...
class OlChristianityPapersType extends StatefulWidget{
  @override
  OlChristianityPapersTypeState createState() => OlChristianityPapersTypeState();

}

class OlChristianityPapersTypeState extends State<OlChristianityPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlCristianityPapers())),
                child: Text('YES'),
              ),
              FlatButton(
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_2000_Christianity_Sinahala.pdf",
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Christianity_English.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Christianity_Tamil.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
