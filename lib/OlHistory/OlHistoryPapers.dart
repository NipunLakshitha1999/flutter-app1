...
import 'OlHistoryPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlHistoryPapers extends StatefulWidget {
  @override
  OlHistoryPapersState createState() => OlHistoryPapersState();
}

class OlHistoryPapersState extends State<OlHistoryPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlHistoryPapersType()));
                  },
                  child: Container(
