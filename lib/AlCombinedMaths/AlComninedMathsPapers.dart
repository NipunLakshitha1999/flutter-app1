...
import 'AlCombinedMathsPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../AlSubjects/SubjectTypeOfAl.dart';
import '../About/AboutApp.dart';


class AlCombinedMathsPapers extends StatefulWidget {
  @override
  AlCombinedMathsPapersState createState() => AlCombinedMathsPapersState();
}

class AlCombinedMathsPapersState extends State<AlCombinedMathsPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AlCombinedMathsPapersType()));
                  },
                  child: Container(
