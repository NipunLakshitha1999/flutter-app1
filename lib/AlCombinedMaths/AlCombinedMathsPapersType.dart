...
class AlCombinedMathsPapersType extends StatefulWidget{
  @override
  AlCombinedMathsPapersTypeState createState() => AlCombinedMathsPapersTypeState();

}

class AlCombinedMathsPapersTypeState extends State<AlCombinedMathsPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AlCombinedMathsPapers())),
                child: Text('YES'),
              ),
              FlatButton(
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Al_2000_ComninedMaths_Sinhala.pdf",
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Al_2000_ComninedMaths_English.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Al_2000_ComninedMaths_Tamil.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
