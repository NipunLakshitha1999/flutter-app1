...
class Grade5Y2000PapersType extends StatefulWidget{
  @override
  Grade5Y2000PapersTypeState createState() => Grade5Y2000PapersTypeState();

}

class Grade5Y2000PapersTypeState extends State<Grade5Y2000PapersType>{
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
        ...
        builder: (c) => AlertDialog(
          ...
          actions: [
            FlatButton(
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => Grdade5())),
              child: Text('YES'),
            ),
            FlatButton(
                      ...
                      children: [
                            ...
                            onPressed: ()async{
                              ...
                              if (status.isGranted) {
                                ...
                                final id = await FlutterDownloader.enqueue(
                                  ...
                                  fileName: "grade5_200_sinhala.pdf",
                        ...
                        TextButton.icon(
                            onPressed: ()async{
                              ...
                              // String fullPath="$path/pdf.pdf";
                              //
                              // downloadFile(dio,imgUrl,fullPath);
                            },
                            ...
                            onPressed: ()async{
                              ...
                              if (status.isGranted) {
                                ...
                                final id = await FlutterDownloader.enqueue(
                                  ...
                                  "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                  savedDir: externalDirectory.path,
                                  fileName: "grade5_200_English.pdf",
                                  showNotification: true,
                                  openFileFromNotification: true,
                                );
