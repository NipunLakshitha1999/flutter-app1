...
import 'Grade5Y2000PapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../About/AboutApp.dart';


class Grdade5 extends StatefulWidget {
  @override
  _Grade5State createState() => _Grade5State();
}

class _Grade5State extends State<Grdade5> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Grade5Y2000PapersType()));
                  },
                  child: Container(
