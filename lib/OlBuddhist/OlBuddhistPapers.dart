...
import 'OlBuddhistPapersType.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlBuddhistPapers extends StatefulWidget {
  @override
  OlBuddhistPapersState createState() => OlBuddhistPapersState();
}

class OlBuddhistPapersState extends State<OlBuddhistPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlBuddhistPapersType()));
                  },
                  child: Container(
