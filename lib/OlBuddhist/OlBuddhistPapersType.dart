...
class OlBuddhistPapersType extends StatefulWidget{
  @override
  OlBuddhistPapersTypeState createState() => OlBuddhistPapersTypeState();

}

class OlBuddhistPapersTypeState extends State<OlBuddhistPapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlBuddhistPapers())),
                child: Text('YES'),
              ),
              FlatButton(
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_Buddhist_Sinhala.pdf",
