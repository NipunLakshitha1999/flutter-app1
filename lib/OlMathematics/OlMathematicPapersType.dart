...
class OlMathematicPapersType extends StatefulWidget{
  @override
  OlMathematicPapersTypeState createState() => OlMathematicPapersTypeState();

}

class OlMathematicPapersTypeState extends State<OlMathematicPapersType>{
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlMathematicsPapers())),
                child: Text('YES'),
              ),
              FlatButton(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'This page include GCE Grade 5 Shcolaship paper and Making Shemes',
                          style: TextStyle(color: Colors.black.withOpacity(0.6)),
                        ),
                      ),
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_Maths_Sinahala.pdf",
