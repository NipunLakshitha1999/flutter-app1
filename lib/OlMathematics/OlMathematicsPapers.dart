...
import 'OlMathematicPapersType.dart';
import '../HomePage/HomeScreen.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlMathematicsPapers extends StatefulWidget {
  @override
  OlMathematicsPapersState createState() => OlMathematicsPapersState();
}

class OlMathematicsPapersState extends State<OlMathematicsPapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlMathematicPapersType()));
                  },
                  child: Container(
