...
class OlSinahalaLitteraturePapersType extends StatefulWidget{
  @override
  OlSinahalaLitteraturePapersTypeState createState() => OlSinahalaLitteraturePapersTypeState();

}

class OlSinahalaLitteraturePapersTypeState extends State<OlSinahalaLitteraturePapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlSinhalaLitterature())),
                child: Text('YES'),
              ),
              FlatButton(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text('Sinhala Litterature ',
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_2000_SinhalaLitterature.pdf",
