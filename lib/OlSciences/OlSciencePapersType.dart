...
import 'OlSciencePapers.dart';
import '../HomePage/HomeScreen.dart';
import '../About/AboutApp.dart';



class OlSciencePapersType extends StatefulWidget{
  @override
  OlSciencePapersTypeState createState() => OlSciencePapersTypeState();

}

class OlSciencePapersTypeState extends State<OlSciencePapersType>{
  int _currentIndex = 0;
    ...
    return new WillPopScope(
      onWillPop: () => showDialog<bool>(
          ...
          builder: (c) => AlertDialog(
            ...
            actions: [
              FlatButton(
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => OlSciencePapers())),
                child: Text('YES'),
              ),
              FlatButton(
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    fileName: "Ol_2000_Science_Sinahala.pdf",
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Science_English.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
                              ...
                              onPressed: ()async{
                                ...
                                if (status.isGranted) {
                                  ...
                                  final id = await FlutterDownloader.enqueue(
                                    ...
                                    "https://drive.google.com/uc?id=14HJWWOTf132gvbjNdcvCXj5zOSjylP-K&export=download",
                                    savedDir: externalDirectory.path,
                                    fileName: "Ol_2000_Scinece_Tamil.pdf",
                                    showNotification: true,
                                    openFileFromNotification: true,
                                  );
