...
import 'OlSciencePapersType.dart';
import '../OlSubjects/SubjectTypeOfOL.dart';
import '../About/AboutApp.dart';


class OlSciencePapers extends StatefulWidget {
  @override
  OlSciencePapersState createState() => OlSciencePapersState();
}

class OlSciencePapersState extends State<OlSciencePapers> {
  int _currentIndex = 0;
  @override
          ...
          child: GridView.extent(
            ...
            children: <Widget>[
              ...
              Container(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OlSciencePapersType()));
                  },
                  child: Container(
